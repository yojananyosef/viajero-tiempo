# CREDITS — licencias de terceros

Regla: ningún asset entra a `assets_3p/` sin fila aquí.
...
- [ ] (vacío) Registrar: autor, URL, licencia, archivos usados.

## OpenGameArt (solo CC0 / CC-BY / CC-BY-SA según filtro)
Fuente: búsqueda avanzada 3D, más valorados.
- [ ] (vacío) Registrar: autor, URL, licencia, atribución si CC-BY.

## Godot / addons
- Terrain3D (licencia MIT, pendiente versión 4.7) — terreno Edén/desierto/Ararat.
- Starter Kit 3D Platformer Kenney (referencia controller, no copiar gameplay red).

## Notas
- Kay Lousberg modular: demo gratis OK, pack completo es de pago — no asumir CC0.
- FlyFF: SOLO referencia de estilo. No usar assets, nombres, ni lore de FlyFF.
